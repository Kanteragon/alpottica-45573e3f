    ...
    <section className="bg-brand-sand/30 py-24">
      <div className="max-w-[1600px] mx-auto px-6 lg:px-10">
        <div className="flex items-end justify-between mb-12">
          <div>
            <p className="text-xs tracking-[0.4em] text-muted-foreground mb-3">ÇOK SATANLAR</p>
            <h2 className="font-display text-5xl md:text-6xl text-brand-ink">Öne Çıkan Ürünler</h2>
          </div>
          <Link
            to="/urunler"

...
const LINKS = [
  ...
  {
    label: "Instagram",
    value: "@mehmetakifdemirel",
    href: "https://instagram.com/mehmetakifdemirel",
    icon: Instagram,
  ...
  },
  {
    ...
    href: "https://www.linkedin.com/in/mehmetakifdemirel",
    icon: Linkedin,
  ...
  },
  {
    label: "GitHub",
    value: "mehmetakifdemirel",
    href: "https://github.com/mehmetakifdemirel",
    icon: Github,

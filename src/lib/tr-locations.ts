// Türkiye il ve ilçe listesi (81 il, resmi ilçeler)
export const TR_ILLER: Record<string, string[]> = {
  ...
  "Bursa": ["Büyükorhan","Gemlik","Gürsu","Harmancık","İnegöl","İznik","Karacabey","Keles","Kestel","Mudanya","Mustafakemalpaşa","Nilüfer","Orhaneli","Orhangazi","Osmangazi","Yenişehir","Yıldırım","Yüksel"],
  ...
  "Isparta": ["Merkez","Aksu","Atabey","Eğirdir","Gelendost","Gönen","Keçiborlu","Senirkent","Sütçüler","Şarkîkaraağaç","Uluborlu","Yalvaç","Yenişarbademli"],
...
export const TR_IL_LIST = Object.keys(TR_ILLER).sort((a, b) => a.localeCompare(b, "tr"));
